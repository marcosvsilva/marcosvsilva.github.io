...
function Card({ as: Component = 'div', className, children }: CardProps) {
...
Card.Eyebrow = function CardEyebrow({ as: Component = 'p', decorate = false, className, children, ...props }: CardEyebrowProps) {
  return (
    <Component
